...
namespace NDde.Internal
{
    internal static class Ddeml
    {
        ...
        public const int APPCMD_FILTERINITS = 0x00000020;
        public const int APPCMD_MASK = 0x00000FF0;
        public const int APPCLASS_STANDARD = 0x00000000;
        public const int APPCLASS_MONITOR = 0x00000001;
        ...
        public const int CBF_FAIL_CONNECTIONS = 0x00002000;
        public const int CBF_FAIL_ADVISES = 0x00004000;
        public const int CBF_FAIL_EXECUTES = 0x00008000;
        public const int CBF_FAIL_POKES = 0x00010000;
        public const int CBF_FAIL_REQUESTS = 0x00020000;
        public const int CBF_FAIL_ALLSVRXACTIONS = 0x0003f000;
        public const int CBF_SKIP_CONNECT_CONFIRMS = 0x00040000;
        public const int CBF_SKIP_REGISTRATIONS = 0x00080000;
        public const int CBF_SKIP_UNREGISTRATIONS = 0x00100000;
        public const int CBF_SKIP_DISCONNECTS = 0x00200000;
        public const int CBF_SKIP_ALLNOTIFICATIONS = 0x003c0000;
        ...
        public const int DNS_REGISTER = 0x0001;
        public const int DNS_UNREGISTER = 0x0002;
        public const int DNS_FILTERON = 0x0004;
        public const int DNS_FILTEROFF = 0x0008;

        public const int EC_ENABLEALL = 0x0000;
        public const int EC_ENABLEONE = 0x0080;
        public const int EC_DISABLE = 0x0008;
        public const int EC_QUERYWAITING = 0x0002;

        public const int HDATA_APPOWNED = 0x0001;

        public const int MF_HSZ_INFO = 0x01000000;
        public const int MF_SENDMSGS = 0x02000000;
        public const int MF_POSTMSGS = 0x04000000;
        public const int MF_CALLBACKS = 0x08000000;
        ...
        public const int XTYPF_NODATA = 0x0004;
        public const int XTYPF_ACKREQ = 0x0008;
        ...
        [DllImport("user32.dll", EntryPoint = "DdeClientTransaction", CharSet = CharSet.Ansi)]
        public static extern IntPtr DdeClientTransaction(
            byte[] pData, int cbData, IntPtr hConv, IntPtr hszItem, int wFmt, int wType, int dwTimeout,
            ref int pdwResult);
        ...
        public static extern IntPtr DdeConnectList(int idInst, IntPtr hszService, IntPtr hszTopic,
            IntPtr hConvList, IntPtr pCC);

        [DllImport("user32.dll", EntryPoint = "DdeCreateDataHandle", CharSet = CharSet.Ansi)]
        public static extern IntPtr DdeCreateDataHandle(int idInst, byte[] pSrc, int cb, int cbOff,
            IntPtr hszItem, int wFmt, int afCmd);
