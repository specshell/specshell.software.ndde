...
/// <remarks>
///     <para>
///         Use a transaction filter to intercept the DDEML callback function.  The <c>PreFilterTransaction</c> method will
///         be called every time the
///         DDEML callback function executes.  The <c>Transaction</c> object passed into the method contains the parameters
///         of the DDE callback
///         function.  By using a transaction filter the developer has compelete control over the DDEML.  See the MSDN
